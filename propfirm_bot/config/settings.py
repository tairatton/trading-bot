...
class Settings:
    ...
    # Bot Identification
    BOT_NAME: str = "Prop Firm Bot"
    BOT_TYPE: str = "PROP_FIRM"  # PROP_FIRM or ORIGINAL
    ...
    RISK_PERCENT: float = float(os.getenv('RISK_PERCENT', '1.0'))  # Optimized: Safe via Dynamic Risk
